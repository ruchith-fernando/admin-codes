...
$sql = "UPDATE tbl_admin_branch_water SET
    ...
    updated_at = NOW() WHERE id=$id LIMIT 1
";
...
if (mysqli_query($conn, $sql)) {
    ...
    try {
        ...
        $msg = "✏️ Updated Water Branch | Code: $branch_code | User: ".$_SESSION['name']." | IP: $ip";
        userlog($msg);
    } catch (Throwable $e) {
        // optional: silently ignore log failures
    }
