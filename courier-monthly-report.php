...
<div class="content font-size">
  <div class="container-fluid">
    <div class="card shadow bg-white rounded p-4">
      <h5 class="mb-4 text-primary">Courier — Monthly Budget vs Actual</h5>

      <!-- View Report -->
      <div class="mb-3">
        <label class="form-label fw-bold">Select Month to View Report</label>
        <select id="courier_month_view" class="form-select">
      ...
      <div id="courier_csv_download_container" class="mb-3 d-none">
        <button class="btn btn-outline-primary" id="courier_download_csv_btn">⬇️ Download CSV</button>
      </div>

      <div id="courier_missing_view_branches" class="alert alert-warning d-none"></div>
      <div id="courier_report_section" class="table-responsive d-none"></div>
      ...
      <div class="mb-3">
        ...
        <select id="courier_month_manual" class="form-select">
      ...
      <div id="courier_missing_manual_branches" class="alert alert-warning mt-3 d-none"></div>
      <div id="courier_provision_info" class="alert alert-info mt-3 d-none"></div>

      <div id="courier_manual_form" class="d-none">
        ...
        <button class="btn btn-success" id="courier_save_entry">Save Entry</button>
      </div>

      <div id="courier_status_msg" class="mt-3"></div>
    </div>
  </div>
</div>
<script src="courier-monthly-report.js"></script>
