...
(function(){
  ...
  const FETCH_CANDIDATES = [
    BASE + 'courier-budget-fetch.php',
    BASE.replace(/[^/]+\/$/, '') + 'courier-budget-fetch.php'
  ];
  ...
  $('#contentArea').on('click' + NS, '#save-remark', function(){
    ...
    $.post(BASE + 'save-remark.php', { category, record, comment, recipients, origin_page: 'courier-overview.php' }, function(response){
