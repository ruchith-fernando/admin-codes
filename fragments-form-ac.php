<?php
// fragments-form-ac.php
require_once 'connections/connection.php';

$id = $_POST['id'] ?? 0;
$sql = "SELECT * FROM tbl_admin_vehicle_maintenance WHERE id = ? AND maintenance_type = 'AC'";
...
<div class="modal-header bg-primary text-white">
    <h5 class="modal-title">Maintenance Entry - Verify AC Details for Vehicle <?php echo $vehicleNumber; ?></h5>
</div>

<div class="modal-body">
    <form id="approveAcForm">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6 mb-3">
                <label for="problem_description" class="form-label">AC Work Description</label>
                <textarea class="form-control bg-light" id="problem_description" name="problem_description" readonly><?= htmlspecialchars($data['problem_description']) ?></textarea>
            </div>
