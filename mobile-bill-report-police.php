...
<div class="content font-size" id="contentArea">
    ...
    <div class="card shadow bg-white rounded p-4">
        <h2 class="mb-4">Mobile Bill Report - Police</h2>
        ...
        <div id="tableContainer">
            <?php include 'mobile-bill-table-police.php'; ?>
        </div>
    </div>
</div>
...
$(document).ready(function(){
    ...
    function loadTable(page, search) {
        $.get('mobile-bill-table-police.php', { page: page, search: search }, function(data){
            $('#tableContainer').html(data);
        });
    }
