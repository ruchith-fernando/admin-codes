    ...
    <body class="bg-light">
        ...
        <div class="content font-size" id="contentArea">
            ...
            <div class="container-fluid">
                ...
                <h5 class="mb-4 text-primary">New SIM/Mobile/Transfer Request</h5>
                ...
                <div id="requestForm" class="form-section" style="display:none;">
                    ...
                    <h5 class="mb-4 text-primary">Request Details</h5>
  ...
  <div class="modal-dialog modal-dialog-centered">
    ...
    <div class="modal-content border-success">
      ...
      <div class="modal-body text-center">
        ...
        Your SIM/Transfer request has been submitted successfully!
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        .then(data => {
            ...
            if (data.toLowerCase().includes("success")) {
                ...
                document.getElementById('requestDetails').reset();
                ...
                // If response does not indicate success, show as alert
