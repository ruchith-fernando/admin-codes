...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['csv'])) {
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== false) {
        ...
        $check = mysqli_query($conn, "SELECT id FROM tbl_admin_actual_newspaper 
        ...
        if ($check && mysqli_num_rows($check) > 0) {
            // update record
            $sql = "UPDATE tbl_admin_actual_newspaper 
            ...
            // insert new record
            $sql = "INSERT INTO tbl_admin_actual_newspaper 
...
?>
<!-- upload-newspaper-actuals.php -->
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<title>Upload newspaper Actuals CSV</title>
<style>
...
<div class="content font-size">
  <div class="container-fluid">
    <div class="card">
      <h5>Upload newspaper Actuals CSV</h5>
      <div id="uploadResult" class="result-block" style="display:none"></div>
      <form id="csvUploadForm" enctype="multipart/form-data" action="upload-newspaper-actuals.php" method="post" novalidate>
        <div class="mb-3">
