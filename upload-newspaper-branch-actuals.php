...
$table = "tbl_admin_actual_branch_gl_newspaper";
$log_table = "tbl_admin_actual_branch_gl_newspaper_upload_log";
$GL_DESC_OVERRIDE = "NEWSPAPER";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['csv'])) {
    if (ob_get_length()) { ob_clean(); } // ensure PURE JSON output
    ...
    while (($data = fgetcsv($handle, 5000, ",")) !== false) {
        ...
        $gl_code              = trim(get_field($data, $hmap, "GL CODE", 0));
        $gl_description       = $GL_DESC_OVERRIDE; // force
...
<head>
<meta charset="utf-8">
<title>Upload Newspaper Branch GL Actuals CSV</title>
<style>
...
<div class="content font-size">
  <div class="container-fluid">
    <div class="card">
      <h5 class="text-primary mb-3">Upload Newspaper Branch GL Actuals CSV</h5>
      ...
      <form id="csvUploadForm"
        ...
        <div class="mb-3">
          ...
          <div class="form-text">
            ...
            <b>GL DESCRIPTION is forced to NEWSPAPER</b>.
...
(function(){
  ...
  $form.on('submit',function(e){
    ...
    $.ajax({
      ...
      // IMPORTANT: avoid jQuery parsererror
      dataType:'text',
