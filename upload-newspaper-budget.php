...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['csv'])) {
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== false) {
        ...
        $check = mysqli_query($conn, "SELECT id FROM tbl_admin_budget_newspaper 
        ...
        if ($check && mysqli_num_rows($check) > 0) {
            // update record
            $sql = "UPDATE tbl_admin_budget_newspaper 
            ...
            // insert new record
            $sql = "INSERT INTO tbl_admin_budget_newspaper 
...
?>
<!-- upload-newspaper-budget.php -->
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<title>Upload News Paper Budget CSV</title>
<style>
...
<div class="content font-size">
  <div class="container-fluid">
    <div class="card">
      <h5>Upload News Paper Budget CSV</h5>
      <div id="uploadResult" class="result-block" style="display:none"></div>
      <form id="csvUploadForm" enctype="multipart/form-data" action="upload-newspaper-budget.php" method="post" novalidate>
        <div class="mb-3">
