...
$table = "tbl_admin_actual_branch_gl_postage";
$log_table = "tbl_admin_actual_branch_gl_postage_upload_log";
$GL_DESC_OVERRIDE = "POSTAGE";
...
<head>
<meta charset="utf-8">
<title>Upload Postage Branch GL Actuals CSV</title>
<style>
...
<div class="content font-size">
  <div class="container-fluid">
    <div class="card">
      <h5 class="text-primary mb-3">Upload Postage Branch GL Actuals CSV</h5>
      ...
      <form id="csvUploadForm"
        ...
        <div class="mb-3">
          ...
          <div class="form-text">
            ...
            <b>GL DESCRIPTION is forced to POSTAGE</b>.
...
(function(){
  ...
  $form.on('submit',function(e){
    ...
    $.ajax({
      ...
      // IMPORTANT: avoid parsererror -> we parse ourselves
      dataType:'text',
