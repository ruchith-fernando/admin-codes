...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['csv'])) {
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== false) {
        ...
        $check = mysqli_query($conn, "SELECT id FROM tbl_admin_branch_printing WHERE branch_code = '$branch_code' LIMIT 1");

        if ($check && mysqli_num_rows($check) > 0) {
            $sql = "UPDATE tbl_admin_branch_printing 
            ...
            $sql = "INSERT INTO tbl_admin_branch_printing (branch_code, branch_name) 
...
<div class="content font-size">
  <div class="container-fluid">
    <div class="card">
      <h5>Upload Printing Branches CSV</h5>
      <div id="uploadResult" class="result-block" style="display:none"></div>
      <form id="csvUploadForm" enctype="multipart/form-data" action="upload-printing-branches.php" method="post" novalidate>
        <div class="mb-3">
