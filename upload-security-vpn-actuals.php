<?php
// upload-security-vpn-actuals.php
session_start();
require_once "connections/connection.php"; // adjust path if needed
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['csv'])) {
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== false) {
        ...
        if ($branch_code === "" || $branch_name === "" || $amount === "" || $month_applicable === "") {
            continue;
        }
        ...
        $check = mysqli_query($conn, "SELECT id FROM tbl_admin_actual_courier 
        ...
        if ($check && mysqli_num_rows($check) > 0) {
            // update record
            $sql = "UPDATE tbl_admin_actual_courier 
            ...
            // insert new record
            $sql = "INSERT INTO tbl_admin_actual_courier 
...
?>
<!-- upload-courier-actuals.php -->
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8">
<title>Upload courier Actuals CSV</title>
<style>
...
<div class="content font-size">
  <div class="container-fluid">
    <div class="card">
      <h5>Upload Courier Actuals CSV</h5>
      <div id="uploadResult" class="result-block" style="display:none"></div>
      <form id="csvUploadForm" enctype="multipart/form-data" action="upload-courier-actuals.php" method="post" novalidate>
        <div class="mb-3">
