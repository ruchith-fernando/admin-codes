<?php
// upload-tea-branches-actuals.php
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['csv'])) {
    ...
    while (($data = fgetcsv($handle, 1000, ",")) !== false) {
        ...
        $check = mysqli_query($conn, "
            SELECT id FROM tbl_admin_actual_tea_branches
            ...
            $sql = "
                INSERT INTO tbl_admin_actual_tea_branches
                    (branch_code, branch, total_amount, month_applicable,
                     ...
                     approval_status, is_provision)
                VALUES
                    ('$branch_code', '$branch_name', '$amount', '$month_applicable',
                     '$entered_hris', '$entered_name', '$entered_by', NOW(),
                     'pending', 'no')
            ";
        ...
        userlog("🍵 Tea Actual Upload | HRIS: $entered_hris | Name: $entered_name | Branch: $branch_name | Code: $branch_code | Month: $month_applicable | Uploaded: $now");
    }
...
<head>
<meta charset="utf-8">
<title>Upload Tea Branches Actuals CSV</title>
<style>
...
<div class="content font-size">
  <div class="container-fluid">
    <div class="card">
      <h5>Upload tea-branches Actuals CSV</h5>
      <div id="uploadResult" class="result-block" style="display:none"></div>
      <form id="csvUploadForm" enctype="multipart/form-data" action="upload-tea-branches-actuals.php" method="post" novalidate>
        <div class="mb-3">
          ...
          <div class="mt-2" style="font-size:.9rem;color:#555">Expected columns: Branch Code, Branch, Amount, Applicable Month</div>
        </div>
